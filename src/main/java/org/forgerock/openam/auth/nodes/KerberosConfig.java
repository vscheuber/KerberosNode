 ...
 *
 * $Id: KerberosConfig.java,v 1.3 2009/04/07 22:55:13 beomsuk Exp $
 *
...
public class KerberosConfig extends AMConfiguration {
    public static final String defaultAppName = 
        "org.forgerock.openam.auth.nodes.KerberosNode";
     ...
     * @param config
     */
    public KerberosConfig(Configuration config) {
        super(config);
        this.config = config;
    }
